...
export default function NewArrivals() {
  ...
  if (loading) {
    return <p className="text-center text-gray-500 py-10">Loading new arrivals...</p>;
  }
  ...
  if (!products.length) {
    return <p className="text-center text-gray-500 py-10">No new arrivals available.</p>;
  }
